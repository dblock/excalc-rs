...
- Standard math functions (radians): `sin cos tan asin acos atan sinh cosh
  tanh asinh acosh atanh sec csc cot asec acsc acot sech csch coth asech
  acsch acoth sqrt ln log logn`.
...
[Unreleased]: https://github.com/dblock/excalc-rs/commits/master
