...
|---|---|---|---|---|---|---|---|---|
| [**excalc-rs**](https://github.com/dblock/excalc-rs) | Rust | Both (one-shot/stdin/REPL) | `f64` | No (conversion functions only) | No | Yes (session-only, no branching) | 214 named functions across math/stats/finance/number theory/combinatorics/geometry/units | Huge flat catalog of named functions covering many domains in one process |
